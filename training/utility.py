...
def ddpg_state_2_spike_value_state(state, normal_state_num,
    ...
    # spike_state_value[2] = state[1]                          # dis_to_goal
    # spike_state_value[3] = state[2] / linear_spd_range       # v(sqrt(x**2 + y**2))
    # if state[3] > 0:
    #     spike_state_value[4] = state[3] / angular_spd_range  # w(z)
...
def ddpg_state_rescale(state, normal_state_num,
    ...
    tmp_list = []
    normal_state = state[0]
    depth_state = state[1]
    rescale_state_value = [0 for _ in range(normal_state_num)]              # [0] x 4
    if normal_state[0] > 0:
    ...
    tmp_list.append(rescale_state_value)   # rescaled normal state: list(1 x 4)
